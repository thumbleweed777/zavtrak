...
if ($empfanger != "all")
$result = $db->query("SELECT user_id FROM " . USERPREFIX . "_users where user_group = '$empfanger' LIMIT ".$startfrom.",".$limit);
else
$result = $db->query("SELECT user_id FROM " . USERPREFIX . "_users LIMIT ".$startfrom.",".$limit);
