...
if( strlen( $name ) > 50 ) {
    ...
    if (preg_match
("/href|url|http|www|\.ru|\.com|\.net|\хрум|\румер|\прогон|\профил|\Xrumer|\X-Rumer|\XRumer|\xrumer|\rumer|\is|\This|\your|\it|\Tramadol|\online|\.su|\.info|\.org/i",
$_POST['comments']) || preg_match
("/href|url|http|www|\.ru|\.com|\.net|\хрум|\румер|\прогон|\профил|\Xrumer|\X-Rumer|\XRumer|\xrumer|\rumer|\is|\This|\your|\it|\Tramadol|\online|\.su|\.info|\.org/i",
$_POST['name'])) {
$stop[] = "Обломитесь )) Ссылки низзя! Если Вы хотите написать комментарий со ссылкой - пишите ее без всяких кодов - авось пройдет";
$CN_HALT = TRUE;
}
