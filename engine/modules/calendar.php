...
function cal($cal_month, $cal_year, $events) {
	global $f, $r, $year, $month, $day, $config, $lang, $langdateshortweekdays, $PHP_SELF;
	...
	$buffer = '<div id="calendar-layer"><table id="calendar" cellpadding="3" class="calendar"><tr><th colspan="7"><center><b>' . $date_link['prev'] . langdate( 'F', $first_of_month ) . ' ' . $cal_year . $date_link['next'] . '</b></center></th></tr><tr>';
