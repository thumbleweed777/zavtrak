...
if( ! $allow_addnews ) {
	...
	if( isset( $_REQUEST['mod'] ) and $_REQUEST['mod'] == "addnews" and $is_logged and $user_group[$member_id['user_group']]['allow_adds'] ) {
		...
		if( $user_group[$member_id['user_group']]['moderation'] ) {
			...
			$admintag = "<input type=\"checkbox\" name=\"allow_comm\" value=\"1\" checked=\"checked\" />" . $lang['add_al_com'];
			...
			$admintag .= "<br><input type=\"checkbox\" name=\"approve\" value=\"1\" checked=\"checked\" /> $lang[add_al_ap]<br><input type=\"checkbox\" name=\"allow_rating\" value=\"1\" checked=\"checked\" /> $lang[addnews_allow_rate]";
