    ...
    <tr>
        ...
        <td bgcolor="#FFFFFF" style="padding:5px;">
                ...
                <tr>
                    <td height="29" bgcolor="#EFEFEF" style="padding-left:10px;">
                        <div class="navigation">
                            <div style="float:left; font-size: 16px;">Навигация модуля "<b>ЕДАТОР первый</b>"</div>
                            <div style="float:right; padding-right: 6px;"><a href="?mod=<?php echo getModuleName() ?>">Вернуться на   главную</a></div>
                        </div>
                    </td>
                </tr>
                </tbody>
            ...
            <table width="100%">
                ...
                <tr>
                    <td width="50%">
                        <div class="quick"><a href="?mod=<?php echo getModuleName() ?>&action=list"><img border="0" align="left"  src="/engine/skins/images/xfset.png">

                            <h3>Список  категорий</h3>Просмотр тэгов, и новостей привязанных к ним сгенерированных модулем</a>
                        </div>
                    </td>
                    <td width="50%">
                        <div class="quick"><a href="?mod=<?php echo getModuleName() ?>&action=config"><img border="0" align="left" src="/engine/skins/images/tools.png">

                            <h3>Настройки парсинга</h3>Управление общими функциями модуля</a></div>
                    </td>
