...
<div style="width:500px; height: 300px;">
    <form id="edit_form" action="?mod=videonator&action=cat_save&id=<?php echo $cat['id'] ?>" method="post">
        ...
        <br ><label for="cat_words">Кл. слова</label><br >
        ...
        <a class="button1" style="color: white" onclick="return confirm('Are you sure you want to delete?')" href="?mod=videonator&action=cat_delete&id=<?php echo $cat['id'] ?>">Удалить</a>
    </form>
