    ...
    <tr>
        ...
        <td bgcolor="#FFFFFF" style="padding:5px;">
                ...
                <tr>
                    <td height="29" bgcolor="#EFEFEF" style="padding-left:10px;">
                        <div class="navigation">
                            <div style="float:left; font-size: 16px;">Навигация модуля "<b>Videonator ))</b>"</div>
                            <div style="float:right; padding-right: 6px;"><a href="?mod=videonator">Вернуться на
                                главную</a></div>
                        </div>
                    </td>
                </tr>
            ...
            <table width="100%">
                ...
                <tr>
                    <td width="50%">
                        <div class="quick"><a href="?mod=videonator&action=list"><img border="0" align="left"  src="engine/skins/referer/graph.png">

                            <h3>Список  категорий</h3>Просмотр тэгов, и новостей привязанных к ним сгенерированных модулем</a>
                        </div>
                    </td>
                    <td width="50%">
                        <div class="quick"><a href="?mod=videonator&action=config"><img border="0" align="left" src="engine/skins/referer/options.png">
