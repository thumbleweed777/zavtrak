...
<div class="auto">
    ...
    <form id="new_form" action="" method="post">
        <label for="cat_name">Назв.</label> <input id="cat_name" type="text" name="cat_name"/>
        <label for="cat_limit">Лимит.</label> <input id="cat_limit" type="text" name="cat_limit"/>
        ...
        <a href="#" onclick="$('#new_form').submit(); return false;" style="color: white" resid="" class="button1">Добавить</a>
    </form>
