...
class VideonatorConfigForm extends sfForm
{
    public function configure()
    {
        ...
        $this->setWidgets(array(
            ...
            'description' => new sfWidgetFormChoice(
                array(
                    'choices' => array('Нет', 'Да'),
                )
            ),
            'comments' => new sfWidgetFormChoice(
                array(
                    'choices' => array('Нет', 'Да'),
                )
            ),
            'num_comments' => new sfWidgetFormInput(),
        ...
        $this->setValidators(array(
            ...
            'num_comments' => new sfValidatorInteger(
                array(
                    'required' => false,
                )
            ),
            ...
            'description' => new sfValidatorChoice(
                array(
                    'choices' => array_keys(array('Включен', 'Выключен')),
                )
            ),
            'comments' => new sfValidatorChoice(
                array(
                    'choices' => array_keys(array('Включен', 'Выключен')),
                )
            ),
    ...
    public function save()
    {
        ...
        # @file_put_contents(ENGINE_DIR . '/inc/videonator/template/full.php', $values['static_template']);

        # unset ($values['static_template']);
        #   $values['block_template'] = addslashes($values['block_template']);


        $this->write_ini_file($values, DATA_DIR . '/videonator.config.ini', false);
