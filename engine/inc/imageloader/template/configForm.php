<div style="">
    Спарсено <b><?php echo $count_img['count'] ?></b> из <?php echo $count_post['count'] ?>, <a target="_blank" href="/engine/inc/imageloader/parser.php">запустить</a>
</div>

<?php if ($saved !== null) : ?>
<link rel="stylesheet" type="text/css" href="/engine/inc/<?php echo getModuleName() ?>/template/css/notice/notice.css">
