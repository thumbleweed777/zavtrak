...
<table width="100%">
    <tr>
        <td width="50%"><div class="quick"><a href="$PHP_SELF?mod=editusers&action=list"><img src="engine/skins/images/users.png" border="0" align="left"><h3>{$lang['opt_user']}</h3>{$lang['opt_userc']}</a></div></td>
        <td><div class="quick"><a href="$PHP_SELF?mod=banners"><img src="engine/skins/images/ads.png" border="0" align="left"><h3>{$lang['opt_banner']}</h3>{$lang['opt_bannerc']}</a></div></td>
    </tr>
    <tr>
        <td><div class="quick"><a href="$PHP_SELF?mod=options&action=syscon"><img src="engine/skins/images/tools.png" border="0" align="left"><h3>{$lang['opt_all']}</h3>{$lang['opt_allc']}</a></div></td>
        <td><div class="quick"><a href="$PHP_SELF?mod=newsletter"><img src="engine/skins/images/email.png" border="0" align="left"><h3>{$lang['main_newsl']}</h3>{$lang['main_newslc']}</a></div></td>
    </tr>
    <tr>
        <td><div class="quick"><a href="$PHP_SELF?mod=static"><img src="engine/skins/images/spset.png" border="0" align="left"><h3>{$lang['opt_static']}</h3>{$lang['opt_staticd']}</a></div></td>
        <td><div class="quick"><a href="$PHP_SELF?mod=clean"><img src="engine/skins/images/clean.png" border="0" align="left"><h3>{$lang['opt_clean']}</h3>{$lang['opt_cleanc']}</a></div></td>
    </tr>
    <tr>
        <td><div class="quick"><a href="$PHP_SELF?mod=rss"><img src="engine/skins/images/rss.gif" border="0" align="left"><h3>{$lang['opt_rss']}</h3>{$lang['opt_rssc']}</a></div></td>
        <td><div class="quick"><a onclick="check_files('lokal'); return false;" href="#"><img src="engine/skins/images/sred.png" border="0" align="left"><h3>{$lang['mod_anti']}</h3>{$lang['anti_descr']}</a></div></td>
    </tr>
</table>
</td>
