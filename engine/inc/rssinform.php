...
<table width="100%">
    <tr>
        ...
        <td><input class=edit style="width: 200px;" type="text" name="rss_tag" value="{$rss_tag}" />&nbsp;&nbsp;&nbsp;({$lang['xf_lat']})</td>
    </tr>
    <tr>
        <td style="padding:4px;">{$lang['rssinform_xdescr']}</td>
        <td><input  class=edit style="width: 315px;" type="text" name="rss_descr" value="{$rss_descr}" /></td>
    </tr>
    <tr>
   ...
   {$opt_category}
	...
	<tr>
        ...
        <td><input  class=edit style="width: 315px;" type="text" name="rss_url" value="{$rss_url}" /></td>
    </tr>
	<tr>
        <td style="padding:4px;">{$lang['opt_sys_an']}</td>
        <td><input  class=edit style="width: 200px;" type="text" name="rss_date_format" value="{$rss_date_format}" /> <a onClick="javascript:Help('date'); return false;" class="main" href="#">{$lang['opt_sys_and']}</a></td>
    </tr>
	<tr>
        <td style="padding:4px;">{$lang['rssinform_template']}</td>
        <td><input  class=edit style="width: 200px;" type="text" name="rss_template" value="{$rss_template}" /> .tpl</td>
    </tr>
	<tr>
        <td style="padding:4px;">{$lang['rssinform_max']}</td>
        <td><input  class=edit style="width: 50px;" type="text" name="rss_max" value="{$rss_max}" /> <a href="#" class="hintanchor" onMouseover="showhint('{$lang[hint_ri_max]}', this, event, '220px')">[?]</a></td>
    </tr>
	<tr>
        <td style="padding:4px;">{$lang['rssinform_tmax']}</td>
        <td><input  class=edit style="width: 50px;" type="text" name="rss_tmax" value="{$rss_tmax}" /> <a href="#" class="hintanchor" onMouseover="showhint('{$lang[hint_ri_tmax]}', this, event, '220px')">[?]</a></td>
    </tr>
	<tr>
        <td style="padding:4px;">{$lang['rssinform_dmax']}</td>
        <td><input  class=edit style="width: 50px;" type="text" name="rss_dmax" value="{$rss_dmax}" /> <a href="#" class="hintanchor" onMouseover="showhint('{$lang[hint_ri_dmax]}', this, event, '220px')">[?]</a></td>
    </tr>
        <tr>
		<td>&nbsp;</td>
    </tr>
...
function confirmdelete(id){
    var agree=confirm("{$lang['rssinform_del']}");
    if (agree)
