...
function cat_list()
{
    ...
    $query = "SELECT c.*, COUNT(v.id) as v_count FROM " . PREFIX . "_" . getModuleName() . "_cat c LEFT JOIN " . PREFIX . "_" . getModuleName() . " v ON v.cat_id = c.id AND v.publish = 1  GROUP BY c.id ORDER BY c.id DESC LIMIT 1500";
