...
<?php if ($saved !== null) : ?>
<link rel="stylesheet" type="text/css" href="/engine/inc/taginator/template/css/notice/notice.css">
<div style="width: 99%;margin-left: auto; margin-right: auto;">
    <?php if ($saved == true) : ?>
    <div class="msg msg-ok"><p> Изменения успешно сохранены</p></div>
    <?php endif; ?>
    <?php if ($saved == false) : ?>
    <div class="msg msg-error"><p>Возникли проблемы при сохранении!</p></div>
    <?php endif; ?>
</div>
<?php endif; ?>
