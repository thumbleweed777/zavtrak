...
if( $_GET['action'] == "add" ) {
	...
	$category = $db->safesql( implode( ',', $category ) );
...
<table width="100%">
    <tr>
        ...
        <td><input type="text" class="edit" name="title" style="width:300px" value="$title"><a href="#" class="hintanchor" onMouseover="showhint('{$lang[hint_vtitle]}', this, event, '250px')">[?]</a></td>
    </tr>
    <tr>
