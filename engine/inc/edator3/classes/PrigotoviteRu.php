 ...
 */
class PrigotoviteRu extends ParserCore
{
    ...
    public function  __construct($charset = 'cp1251', $url, $pageF, $pageT, $config)
    {
        ...
        $this->PostLinksPath = '.module_article_name a';
        $this->PageLinksPath = '[href*=list]';
    ...
    public function getMethod()
    {
        ...
        if ($dom instanceof simple_html_dom) {
            ...
            $text = trim($dom->find('.module_show p', 2)->innertext);
