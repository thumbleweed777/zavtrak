 ...
 */
class CafeonlineRu extends ParserCore
{
    ...
    public function  __construct($charset = 'cp1251', $url, $pageF, $pageT, $config)
    {
        ...
        $this->PostLinksPath = 'a.receipt_link';
        $this->PageLinksPath = '[href*=start]';
        $this->PageLinksPattern = 'start=(\d+)';
    ...
    public function getIngredients()
    {
     ...
     #   return false;
        ...
        if ($dom instanceof simple_html_dom) {
            ...
            $count = count($dom->find('div table tbody tr td index div'));

            if ($count == 5) return false;

            $text = $dom->find('div table tbody tr td index div', 4)->innertext;
    ...
    public function getMethod()
    {
        ...
        if ($dom instanceof simple_html_dom) {
            ...
            $text = trim($dom->find('.recipe-text', 0)->innertext);
    ...
    public function getPageLinksReplace($href, $i)
    {
        ...
        $replace = str_ireplace('(\d+)', $i * 5, $pattern);
