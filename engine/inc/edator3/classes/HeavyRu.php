 ...
 */
class HeavyRu extends ParserCore
{
    ...
    public function  __construct($charset = 'cp1251', $url, $pageF, $pageT, $config)
    {
        ...
        $this->PostLinksPath = '.itemListCategory a';
    ...
    public function getTitle()
    {
        ...
        if ($dom instanceof simple_html_dom) {
            $text = trim($dom->find('h2.itemTitle', 0)->plaintext);
    ...
    public function getIngredients()
    {
        ...
        if ($dom instanceof simple_html_dom) {
            ...
            if (!$dom->find('.ingred', 0))
                return false;

            $text = $dom->find('.ingred', 0)->innertext;
    ...
    public function getMethod()
    {
        ...
        if ($dom instanceof simple_html_dom) {
            ...
            $text = trim($dom->find('.itemFullText', 0)->innertext);
