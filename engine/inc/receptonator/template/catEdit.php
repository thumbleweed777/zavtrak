...
<div style="width:500px; height: 300px;">
    <form id="edit_form" action="<?php echo $_SERVER['PHP_SELF'] ?>?mod=receptonator&action=cat_save&id=<?php echo $cat['id'] ?>" method="post">
        ...
        <a class="button1" style="color: white" onclick="return confirm('Are you sure you want to delete?')" href="<?php echo $_SERVER['PHP_SELF'] ?>?mod=receptonator&action=cat_delete&id=<?php echo $cat['id'] ?>">Удалить</a>
    </form>
