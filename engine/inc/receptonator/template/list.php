...
<script src="/engine/inc/receptonator/template/js/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
<link rel="stylesheet" type="text/css" media="screen" href="/engine/inc/receptonator/template/js/fancybox/jquery.fancybox-1.3.4.css"/>
...
<div class="auto">
    <div style="display: none;">
        <div id="add_form">
            <form id="new_form" action="" method="post">
                ...
                <label for="cat_query">Запрос</label> <input id="cat_query" type="text" value="<?php echo $cat['query'] ?>" name="cat_query"/><br/>
                <br/>
    ...
    <a style="color: white; float: right;" target="_blank" href="/engine/inc/receptonator/parser.php" class="button1 green">Запуск</a>
</div>
        ...
        <tr>
            ...
            <td>
                <a href="#" onclick="$.fancybox({
                    'href'  : '<?php echo $_SERVER['PHP_SELF'] ?>?mod=receptonator&action=cat_edit&id=<?php echo $res['id'] ?>'
            ...
            <td>
                ...
                <a style="color: #ff0000;" href="#" onclick="
                    ...
                    $.fancybox({
                    'href'            : '<?php echo $_SERVER['PHP_SELF'] ?>?mod=receptonator&action=cat_full_delete&id=<?php echo $res['id'] ?>'
                    });
                    }
                    " accesskey="">Удалить</a>
            </td>
