    ...
    <tr>
        ...
        <td bgcolor="#FFFFFF" style="padding:5px;">
                ...
                <tr>
                    <td height="29" bgcolor="#EFEFEF" style="padding-left:10px;">
                        <div class="navigation">
                            <div style="float:left; font-size: 16px;">Навигация модуля "<b>РЕЦЕПТОНАТОР</b>"</div>
                            <div style="float:right; padding-right: 6px;"><a href="?mod=receptonator">Вернуться на
                                главную</a></div>
                        </div>
                    </td>
                </tr>
            ...
            <table width="100%">
                ...
                <tr>
                    <td width="50%">
                        <div class="quick"><a href="?mod=receptonator&action=list"><img border="0" align="left"  src="/engine/skins/images/xfset.png">

                            <h3>Список  категорий</h3>Просмотр тэгов, и новостей привязанных к ним сгенерированных модулем</a>
                        </div>
                    </td>
                    <td width="50%">
                        <div class="quick"><a href="?mod=receptonator&action=config"><img border="0" align="left" src="/engine/skins/images/tools.png">
