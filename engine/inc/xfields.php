...
<table width="100%">
    <tr>
        <td width="200" style="padding:4px;"><?=$lang['xfield_xname']?></td>
        <td><input class=edit style="width: 300px;" type="text" name="editedxfield[0]" value="<? echo $editedxfield[0];?>" />&nbsp;&nbsp;&nbsp;(<?=$lang['xf_lat']?>)</td>
    </tr>
    <tr>
...
?>
    <tr>
        ...
        <td><select name="editedxfield[3]" id="type" onchange="onTypeChange(this.value)" />
          <option value="text"<?=($editedxfield[3] != "textarea") ? " selected" : ""?>><?=$lang['xfield_xstr']?></option>
          <option value="textarea"<?=($editedxfield[3] == "textarea") ? " selected" : ""?>><?=$lang['xfield_xarea']?></option>
          <option value="select"<?=($editedxfield[3] == "select") ? " selected" : ""?>><?=$lang['xfield_xsel']?></option>
        </select></td>
    </tr>
	<tr id="default_text">
        <td style="padding:4px;"><?=$lang['xfield_xfaul']?></td>
    ...
    <tr>
      ...
      <span><input type="checkbox" name="editedxfield[5]"<?=$checked?> id="editxfive" />
    <label for="editxfive"> <?=$lang['xfield_xw']?></label></span></div></td>
    </tr>
    <tr>
...
<table width="100%">
    <tr>
        <td bgcolor="#EFEFEF" height="29" style="padding-left:10px;"><div class="navigation"><?=$lang['xfield_xlist']?></div></td>
    </tr>
</table>
<div class="unterline"></div>
<table width="100%">
...
?>
    <tr>
      ...
      <tr>
		<td ><a class=main onClick="javascript:Help('xfields')" href="#"><?=$lang['xfield_xhelp']?></a></td>
