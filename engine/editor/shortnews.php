...
<script type="text/javascript">
	tinyMCE.init({
		...
		width : "98%",
		height : "400",
		plugins : "safari,layer,table,style,advhr,spellchecker,advimage,emotions,inlinepopups,insertdatetime,media,searchreplace,print,contextmenu,paste,fullscreen,nonbreaking",
		...
		// Theme options
		theme_advanced_buttons1 : "fullscreen,|,cut,copy,|,paste,pastetext,pasteword,|,search,replace,|,outdent,indent,|,undo,redo,|,link,dle_leech,|,dle_upload,image,media,dle_mp,dle_mp3,emotions,dle_spoiler,|,nonbreaking,dle_quote,dle_code,dle_hide,dle_break,dle_page",
		theme_advanced_buttons2 : "print,|,tablecontrols,|,styleprops,spellchecker,|,sub,sup,|,charmap,advhr,visualaid,|,insertdate,inserttime,|,insertlayer,moveforward,movebackward,absolute",
