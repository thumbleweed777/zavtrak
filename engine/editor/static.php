...
<script type="text/javascript">
	tinyMCE.init({
		...
		width : "98%",
		height : "400",
		plugins : "safari,layer,table,advhr,advimage,emotions,inlinepopups,insertdatetime,media,searchreplace,print,contextmenu,paste,fullscreen,nonbreaking",
		relative_urls : false,
		convert_urls : false,
		...
		// Theme options
		theme_advanced_buttons1 : "fullscreen,|,cut,copy,|,paste,pastetext,pasteword,|,search,replace,|,outdent,indent,|,undo,redo,|,link,dle_leech,|,dle_upload,image,media,dle_mp,dle_mp3,emotions,dle_spoiler,|,nonbreaking,dle_quote,dle_hide,dle_code,dle_break,dle_page",
		theme_advanced_buttons2 : "print,|,tablecontrols,|,hr,visualaid,|,sub,sup,|,charmap,advhr,|,insertdate,inserttime,|,insertlayer,moveforward,movebackward,absolute",
